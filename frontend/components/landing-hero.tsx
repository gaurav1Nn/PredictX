...
export function LandingHero({ onConnect }: LandingHeroProps) {
  ...
  const handleStartPredicting = async (e: React.MouseEvent) => {
    e.preventDefault();
    e.stopPropagation();
    ...
    try {
      ...
      // The parent component (Home) will handle the redirection through its router
    } catch (error) {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        {/* Value Props */}
        <div id="how-it-works" className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div>
